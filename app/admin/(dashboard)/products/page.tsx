      ...
      <div className="glass p-6 rounded-2xl border border-white/10 min-h-[500px]">
        <div className="flex flex-col md:flex-row gap-4 mb-6 items-center justify-between">
                ...
                <div className="flex items-center gap-2 w-full md:w-auto">
                    ...
                    <select className="w-full md:w-32 px-4 py-2 bg-surface/50 border border-white/10 rounded-xl text-sm focus:outline-none focus:border-gold transition-colors appearance-none">
