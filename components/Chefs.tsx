    ...
    <section id="chefs" className="mx-auto max-w-7xl px-5 py-24 md:px-8 md:py-32">
      <div className="reveal mb-10 md:mb-14 flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="flex gap-3 justify-center md:pb-2">
          <button 
            onClick={scrollPrev}
            className="grid h-12 w-12 place-items-center rounded-full border border-white/10 bg-surface/50 text-foreground transition-all hover:bg-gold hover:text-background hover:border-gold"
      ...
      >
        ...
        {finalChefs.map((c, idx) => (
          <div key={idx} className="flex-none w-[85%] md:w-[calc(33.333%-16px)] snap-center">
            <article className="h-full reveal group overflow-hidden rounded-3xl border border-white/5 bg-card hover-lift flex flex-col">
